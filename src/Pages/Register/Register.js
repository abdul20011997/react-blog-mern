...
export default function Register() {
    ...
    return (
        ...
        backgroundPosition: 'center'
            ...
            <TextField required placeholder="Enter Username" id="outlined-required" color="primary" label="Username" style={{marginTop:'20px',marginBottom:'20px',display:'block'}} fullWidth/>
            ...
            <Button style={{marginTop:'15px'}} color="success" variant="contained">Register</Button>
